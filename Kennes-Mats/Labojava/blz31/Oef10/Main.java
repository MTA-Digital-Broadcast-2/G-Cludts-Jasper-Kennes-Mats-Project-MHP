...

{
	...
	//oef10
	Factuur fact1= new Factuur(99,1);
	fact1.betaal();
	
	
	//demo interfaces
	Betaalbaar tebetalen[] = new Betaalbaar[2]; //ARRAY VAN BETAALBARE OBJECTEN
	
	tebetalen[0] = Marc;     //studentwerknemer
	tebetalen[1] = fact1;      //factuur
	
	for (int i=0; i<2;i++)
	{
	tebetalen[i].betaal();      //betaal alle objecten
	}
